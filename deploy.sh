...
echo "执行命令：git push -f https://github.com/Logistic98/Found-monthly.git master:gh-pages"
git push -f https://github.com/Logistic98/Found-monthly.git master:gh-pages
